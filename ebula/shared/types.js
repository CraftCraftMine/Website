...
const DEMO_ROUTE = {
  ...
  timetables: [{
    id:'tt_demo1', name:'RE 4711 · Demo', mode:'TIME',
    departure:'10:00:00', avgSpeed:100,
    createdAt:'2026-02-22T10:00:00Z',
    zugNummer:'RE 4711', zugTyp:'RE', richtung:1,
    stops:[
...
function checkReservedAuthor(name) {
  ...
  for (const r of RESERVED_AUTHORS) {
    if (lower.includes(r)) {
      return `„${name}" enthält einen geschützten Namen des CraftCraftMine Netzwerks™.\nBitte deinen eigenen Namen verwenden.\nSupport: support@craftcraftmine.net`;
    }
  }
  return null;
}
...
const JSON_META = {
  _ccmn: {
    project:    'CCMC™ Web EBuLa',
    partOf:     'CraftCraftMine Netzwerk™',
    copyright:  '(c) 2026 CraftCraftMine Netzwerk™ – All rights reserved.',
